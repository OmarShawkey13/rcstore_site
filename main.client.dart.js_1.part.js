...
x=C.ie(new B.fQ(w))
w.f=x
C.t(b.G.window).addEventListener("scroll",x)},
bE(){var x=this,w=C.ic(C.t(b.G.window).scrollY)
if(w>50&&!x.e)x.a7(new B.fM(x))
else if(w<=50&&x.e)x.a7(new B.fN(x))},
aI(){var x=this.f
if(x!=null)C.t(b.G.window).removeEventListener("scroll",x)
x=this.r
...
C.t(d)
x=this.a
if(!x.w){x.r=C.am(C.t(b.G.window).requestAnimationFrame(C.ie(new B.fP(x))))
x.w=!0}},
$S:40}
B.fP.prototype={
$1(d){var x
